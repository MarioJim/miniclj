...
The compiler state is enclosed inside the \texttt{CompilerState} struct, inside file \path{miniclj-lib/src/compiler/state.rs} or in the appendix \ref{apdx:compstate}.
...
\chapter{CompilerState struct}
\label{apdx:compstate}
\inputminted{rust}{/home/mario/git/MarioJim/miniclj/miniclj-lib/src/compiler/state.rs}
